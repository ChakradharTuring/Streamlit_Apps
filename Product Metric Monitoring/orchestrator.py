...
def get_all_anomalies(supply_metrics, matching_metrics, selfserv_metrics):
    ...
    Returns:
        (df): Predictions by the model for the past week data for each metric
    """
...
def run_monitoring():
    ...
    supply_metrics, matching_metrics, selfserv_metrics, glossary = get_all_data()
    supply_forecasts, matching_forecasts, selfserv_forecasts = get_all_anomalies(supply_metrics, matching_metrics, selfserv_metrics)
